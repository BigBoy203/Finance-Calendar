...
4. Navigation: bottom tab bar texts `Home / Overview / Spending / Bills`; the raised ＋ is `.mobile-tab-add`; on desktop the sidebar rows are `.sidebar-link`. List items open edit modals on click.
